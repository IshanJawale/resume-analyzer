...
def project_name(project):
    ...
    if isinstance(project, dict):
        return project.get('name') or project.get('title') or project.get('project_name') or 'Project'
...
def project_technologies(project):
    ...
    if isinstance(project, dict):
        techs = project.get('technologies') or project.get('tech_stack') or project.get('tools') or []
